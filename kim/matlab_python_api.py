...
class SimulinkPlant:
    ...
    def setControlAction(self,u):
        ...
        self.eng.set_param('{}/u'.format(self.modelName),'value',str(u),nargout=0) # set_param('plant/u', 'value', '0') in Matlab
    
    def getHistory(self):
        #Helper Function to get Plant Output and Time History
        # output = self.eng.eval("out.output")
...
controller.fig.set_xdata(controller.tHist)
controller.fig.set_ydata(controller.yHist)
plt.show()
